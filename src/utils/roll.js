...
export class RollUtility {
    static processActorRoll(config) {
        ...
        config.advantage = config.advantage || advMode === CONFIG.Dice.D20Roll.ADV_MODE.ADVANTAGE;
        config.disadvantage = config.disadvantage || advMode === CONFIG.Dice.D20Roll.ADV_MODE.DISADVANTAGE;
    ...
    static processItemRoll(options) {
        ...
        options.advantage = options.advantage || advMode === CONFIG.Dice.D20Roll.ADV_MODE.ADVANTAGE;
        options.disadvantage = options.disadvantage || advMode === CONFIG.Dice.D20Roll.ADV_MODE.DISADVANTAGE;
